                    ...
                    columns_basic.setOption({
                        ...
                        series: [{
                                ...
                                data: [
                                    ...
                                    "{{ $studyAbroad['last_day_revenue']['ielts-general-turbo'] }}",
                                    "{{ $studyAbroad['last_day_revenue']['ielts-specialized-course'] }}",
                            ...
                            },
                            {
                                ...
                                data: [
                                    ...
                                    "{{ $studyAbroad['today_revenue']['ielts-general-turbo'] }}",
                                    "{{ $studyAbroad['today_revenue']['ielts-specialized-course'] }}",
                    ...
                    columns_basic.setOption({
                        ...
                        series: [{
                                ...
                                data: [
                                    ...
                                    "{{ $studyAbroad['last_day_enrollment']['ielts-general-turbo'] }}",
                                    "{{ $studyAbroad['last_day_enrollment']['ielts-specialized-course'] }}",
                            ...
                            },
                            {
                                ...
                                data: [
                                    ...
                                    "{{ $studyAbroad['today_enrollment']['ielts-general-turbo'] }}",
                                    "{{ $studyAbroad['today_enrollment']['ielts-specialized-course'] }}",
