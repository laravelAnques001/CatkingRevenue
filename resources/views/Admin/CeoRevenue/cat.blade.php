        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                @if ($cat['total_revenue']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($cat['total_revenue']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($cat['total_revenue']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($cat['total_revenue']['per'], 2) }}% <i
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                @if ($cat['enrollment']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($cat['enrollment']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($cat['enrollment']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($cat['enrollment']['per'], 2) }}% <i
                            class="ph-trend-down me-2"></i></span>
                @else
                    <span class="text-info ms-2">0.00%</span>
                @endif
