...
<div class="row">
    <div class="{{ $commonGraph['selected_course']=='undergrad'||$commonGraph['selected_course']=='gdpi'?'col-lg-6':'col-lg-12'}}">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="fw-semibold mb-0">Total Revenue</h5>
                <span class="mx-3">{{ $commonGraph['total_today_revenue'] }}</span>
                @if ($commonGraph['per_today_revenue'] > 0)
                <span class="text-success ms-2">{{ $commonGraph['per_today_revenue'] }}% <i class="ph-trend-up me-2"></i></span>
                @elseif($commonGraph['per_today_revenue'] < 0) <span class="text-danger ms-2">{{ $commonGraph['per_today_revenue'] }}% <i class="ph-trend-down me-2"></i></span>
                    @else
    ...
    <div class="{{ $commonGraph['selected_course']=='undergrad'||$commonGraph['selected_course']=='gdpi'?'col-lg-6':'col-lg-12'}}">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <span class="mx-3">{{ $commonGraph['total_today_enrollment'] }}</span>
                @if ($commonGraph['per_today_enrollment'] > 0)
                <span class="text-success ms-2">{{ $commonGraph['per_today_enrollment'] }}% <i class="ph-trend-up me-2"></i></span>
                @elseif($commonGraph['per_today_enrollment'] < 0) <span class="text-danger ms-2">{{ $commonGraph['per_today_enrollment'] }}% <i class="ph-trend-down me-2"></i></span>
                    @else
                    <span class="text-info ms-2">0.00%</span>
                    @endif
                    <div class="ms-auto ">
