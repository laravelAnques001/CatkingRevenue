                    ...
                    columns_basic.setOption({
                        ...
                        series: [{
                                ...
                                data: [
                                    ...
                                    "{{ $nonCat['last_day_revenue']['srcc-gbo-mock'] }}",
                                ],
                                itemStyle: {
                                    normal: {
                            ...
                            },
                            {
                                ...
                                data: [
                                    ...
                                    "{{ $nonCat['today_revenue']['srcc-gbo-mock'] }}",
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
                    ...
                    columns_basic.setOption({
                        ...
                        series: [{
                                ...
                                data: [
                                    ...
                                    "{{ $nonCat['last_day_enrollment']['srcc-gbo-mock'] }}",
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
                            ...
                            },
                            {
                                ...
                                data: [
                                    ...
                                    "{{ $nonCat['today_enrollment']['srcc-gbo-mock'] }}",
                                ],
                                itemStyle: {
                                    normal: {
                                        barBorderRadius: [4, 4, 0, 0],
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                @if ($nonCat['total_revenue']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($nonCat['total_revenue']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($nonCat['total_revenue']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($nonCat['total_revenue']['per'], 2) }}% <i
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                @if ($nonCat['enrollment']['per'] > 0)
                    <span class="text-success ms-2">{{ number_format($nonCat['enrollment']['per'], 2) }}% <i
                            class="ph-trend-up me-2"></i></span>
                @elseif($nonCat['enrollment']['per'] < 0)
                    <span class="text-danger ms-2">{{ number_format($nonCat['enrollment']['per'], 2) }}% <i
                            class="ph-trend-down me-2"></i></span>
                @else
                    <span class="text-info ms-2">0.00%</span>
                @endif
