...
class CEOController extends Controller
{
    ...
    public function getRevenueData()
    {
        ...
        $data['this_year_emi_enrollments_per'] = number_format((($data['this_year_emi_enrollments'] * 100) / (isset($totalEMIEnrollments) ? $totalEMIEnrollments : 1)), 2);
        $data['last_year_emi_enrollments_per'] = number_format((($data['last_year_emi_enrollments'] * 100) / (isset($totalEMIEnrollments) ? $totalEMIEnrollments : 1)), 2);
        $data['this_year_emi_revenue_per'] = number_format((($data['this_year_emi_revenue'] * 100) / (isset($totalEMIRevenue) ? $totalEMIRevenue : 1)), 2);
        $data['last_year_emi_revenue_per'] = number_format((($data['last_year_emi_revenue'] * 100) / (isset($totalEMIRevenue) ? $totalEMIRevenue : 1)), 2);
